...
Только в данных товарах не должно быть болгарского перца, так как и так открыта данная страница. Количество товаров для показывания
можете выбрать самостоятельно, это может быть допустим не более 5 товаров.
